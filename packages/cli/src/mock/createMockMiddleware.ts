/*
 * @Author: jimmyZhao
 * @Date: 2023-10-11 11:38:43
 * @LastEditors: jimmyZhao
 * @LastEditTime: 2023-10-17 15:18:23
 * @FilePath: /vg-cli/packages/cli/src/mock/createMockMiddleware.ts
 * @Description:
 */
import type { RequestHandler } from '@/index';
import { bodyParser, multer, pathToRegexp } from '@/index';

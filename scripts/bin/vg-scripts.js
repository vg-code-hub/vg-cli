...
const { sync } = require('@vg-code/utils/compiled/cross-spawn')
const chalk = require('@vg-code/utils/compiled/chalk').default
...
console.log(chalk.cyan(`vg-scripts: ${name}\n`))
...
if (spawn.status !== 0) {
  console.log(chalk.red(`vg-scripts: ${name} execute fail`))
  process.exit(1)
}
